...
fdtd = FDTD(L,delta,T_max,d,source_func,source_pos,L_slab,slab_pos,epsR_func1,E0_func1,H0_func1,J_func1,cfl=1/2,eps_0=1,mu_0=1,boundary_condition="PEC")
fdtd.run()
n5 = int(5/fdtd.dt)
...
plt.show()
err = np.linalg.norm(fdtd.Ez[n5, :]-E_ext[n5, :])
err2 = np.linalg.norm(fdtd.Hy[n5, :]-H_ext[n5, :])
...
fdtd2 = FDTD(L,delta,T_max,d,source_func,source_pos,L_slab,slab_pos,epsR_func2,E0_func2,H0_func2,J_func2,cfl=1/2,boundary_condition="PEC",eps_0=1,mu_0=1)
...
plt.show()
err = np.linalg.norm(fdtd2.Ez[n5, :]-E_ext2[n5, :])
err2 = np.linalg.norm(fdtd2.Hy[n5, :]-H_ext2[n5, :])
